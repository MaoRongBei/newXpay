...
//import com.unionpay.xwmch.web.api.ApiException;
//import com.unionpay.xwmch.web.constants.Constants;

public class ApiSignatureUtil {

	protected final static Logger logger = LogManager.getLogger();
	//Logger logger = Logger.getLogger(ApiSignatureUtil.class);
...
/*    public static String getSignatureContent(RequestParametersHolder requestHolder) {
    ...
    public static Map<String, String> getSortedMap(RequestParametersHolder requestHolder) {
        ...
        UnionpayHashMap appParams = requestHolder.getApplicationParams();
        if (appParams != null && appParams.size() > 0) {
            sortedParams.putAll(appParams);
        }
        UnionpayHashMap protocalMustParams = requestHolder.getProtocalMustParams();
        if (protocalMustParams != null && protocalMustParams.size() > 0) {
            sortedParams.putAll(protocalMustParams);
        }
        UnionpayHashMap protocalOptParams = requestHolder.getProtocalOptParams();
    ...
    public static String rsaSign(Map<String, String> params, String privateKey,
                                 String charset) throws ApiException {
        String signContent = getSignContent(params);
        if (Constants.SIGN_TYPE_RSA.equalsIgnoreCase(params.get(Constants.SIGN_METHOD))) {

        	return rsaSign(signContent, privateKey, charset);

        } else if (Constants.SIGN_TYPE_RSA2.equalsIgnoreCase(params.get(Constants.SIGN_METHOD))) {

        	 return rsa256Sign(signContent, privateKey, charset);

        } else {
            throw new ApiException("Sign Type is Not Support : signType=" + params.get(Constants.SIGN_METHOD));
        }
    ...
    public static String getSignCheckContentV2(Map<String, String> params) {
        ...
        logger.info("待签名的字符串="+content.toString());
        return content.toString();
    }
    ...
    public static boolean rsaCheckV2(Map<String, String> params, String publicKey,
        ...
        if (Constants.SIGN_TYPE_RSA.equalsIgnoreCase(signType)) {

            return rsaCheckContent(content, sign, publicKey, charset);

        } else if (Constants.SIGN_TYPE_RSA2.equalsIgnoreCase(signType)) {
    ...
    public static boolean rsa256CheckContent(String content, String sign, String publicKey,
                                             String charset) throws ApiException {
    	logger.info("签名方式为RSA2");
    	logger.info("验证签名公钥为："+publicKey);
    	logger.info("待验证签名为："+sign);
    	logger.info("待验证签名内容为："+content);
        try {
    ...
    public static boolean rsaCheckContent(String content, String sign, String publicKey,
        ...
        try {
            ...
            throw new ApiException(Constants.CODE_INVALID_SIGNATURE,
                    Constants.CODE_MAP.get(Constants.CODE_INVALID_SIGNATURE));
        }
    }
   ...
   /* public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
    ...
    public static String rsaEncrypt(String content, String publicKey,
        ...
        try {
            ...
            byte[] data = CommonUtil.isEmpty(charset) ? content.getBytes()
            ...
            return CommonUtil.isEmpty(charset) ? new String(encryptedData)
    ...
    public static String rsaDecrypt(String content, String privateKey,
        ...
        try {
            ...
            byte[] encryptedData = CommonUtil.isEmpty(charset)
            ...
            return CommonUtil.isEmpty(charset) ? new String(decryptedData)
