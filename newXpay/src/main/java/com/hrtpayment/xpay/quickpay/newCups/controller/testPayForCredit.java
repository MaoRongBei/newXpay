 ...
 *
 */
public class testPayForCredit {
	
	@Value("${cupsquickpay.testUrl}")
	private String Url;
	
	@RequestMapping("testPayForCredit")
	@ResponseBody
	public   void main(String[] args) {
		...
		trxInfBean.setTrxAmt("CNY0000000000000052.12");
