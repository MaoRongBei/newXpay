...
public class testPay {
	...
	public   void main(String[] args) {
		...
		ordrInfBean.setOrdrId("201802130000000001");
		...
		channelIssrInfBean.setSgnNo("UPW0ISS0014864100001048641000W0ISS001201805180000000089");//签约协议号
