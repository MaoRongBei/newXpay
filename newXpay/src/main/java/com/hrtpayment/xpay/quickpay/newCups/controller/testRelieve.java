 ...
 *
 */
public class testRelieve {
	
	@Value("${cupsquickpay.testUrl}")
	private String Url;
	
	@RequestMapping("testRelieve")
	@ResponseBody
...
//		rcverInfBean.setRcverAcctIssrId("");
		rcverInfBean.setRcverAcctId("48641000");//接收方账户号
		rcverInfBean.setSgnNo("UPW0ISS0014864100001048641000W0ISS001201805180000000059");//扣款协议编号
