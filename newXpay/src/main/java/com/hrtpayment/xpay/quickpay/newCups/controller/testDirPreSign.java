 ...
 *
 */
public class testDirPreSign {
	
	@Value("${cupsquickpay.testUrl}")
	private String Url;
	
	@RequestMapping("testCupsQuickDirPay")
	@ResponseBody
...
//		headerBean.setEncAlgo("");
		...
		trxInfBean.setTrxId("2018032600000004");//0131202721000000
...
//		trxInfBean.setSettlmDt("");
		...
		rcverInfBean.setRcverAcctId("6224243000000011");//接收方账户号6212143000000000011
		rcverInfBean.setRcverNm("com");//接收方名称
		rcverInfBean.setIDTp("01");//接收方证件类型
		rcverInfBean.setIDNo("310115197803261111");//接收方证件号
		rcverInfBean.setMobNo("13222222222");//13111111111");//接收方手机号
		//接收方证件号
		//接收方预留手机号
		/**
		 * 发起方 信息
